...
Route::get('/delete-product/{id}',[ProductController::class, 'dropProducts'])->middleware(['auth']);

// Route::match(['get', 'delete'],'/delete-product/{id}',[ProductController::class, 'dropProducts'])->middleware(['auth']);
