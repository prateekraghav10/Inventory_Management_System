                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseContacts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <!-- <a class="nav-link" href="{{ route('add.contact') }}">Intro</a> -->
                                    <!-- <a class="nav-link" href="{{ route('add.contact') }}">Intro</a> -->
                                    <a class="nav-link" href="{{ route('add.contact') }}">Add Contact</a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Prateek Raghav</div>
                            <div>
